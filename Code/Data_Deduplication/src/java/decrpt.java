...
/**
 *	User Interface for DES File Encryption/Decryption
...
//		}
     ...
     public void decrypt(String enc_file)
     {
         
         
         
         
         	File file = new File(enc_file);
			
             String fn=enc_file;
            int l=fn.length();
            fn=fn.substring(0, (l-4));
            fn=fn+".key";
            File keyFile = new File(fn);
			//get encrypted file and key
//			if (!file.exists()){
//				JOptionPane.showMessageDialog(null,
//					"Encrypted file not found or cannot be accessed.",
